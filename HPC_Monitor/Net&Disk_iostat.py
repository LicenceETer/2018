...
rrdtool.graph("/python/HPC_Monitor/N&D_Status.png","--start","-1d","--vertical-label=Usage","--x-grid",
    ...
    #        "COMMENT:\\r",
            ...
            "COMMENT:\\r",
            "GPRINT:netin:MAX:MAX_NET_IN\: %6.2lf %Sbps",
            "GPRINT:netout:MAX:MAX_NET_OUT\: %6.2lf %Sbps\\r",
            "GPRINT:diskin:MAX:MAX_DISK_READ\: %6.2lf %Sb/s",
            "GPRINT:diskout:MAX:MAX_DISK_WRITE\: %6.2lf %Sb/s\\r",
            "GPRINT:disktotal:AVERAGE:AVERAGE_DISK_IO\: %6.2lf %Sb/s\\r",)
